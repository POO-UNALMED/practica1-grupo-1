...
public class Main {
	...
	public static void main(String[] args) {
		...
		Destino.setDestinoSinVisado("Espa�a");

		
		//Creamos algunos destinos
		Destino destino1 = new Destino("Ibiza", "Espa�a", 1500);
...
//            }
	...
	public static void venderTiquete() {
		...
		// Se pregunta por el documento del viajero para después verificar si se
		// encuentra o no entre los inscritos:
		...
		Destino destino1 = new Destino("San Andres", "Colombia", 973);
		Tiquete tiquete1 = new Tiquete(viajeroActual, agenteActual, transporte1, destino1);
