...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try{
            //Escribir
            ObjectOutputStream escribir = new ObjectOutputStream(new FileOutputStream(archivo.getAbsolutePath()+ "\\src\\BaseDatos\\temp.txt"));
            escribir.writeObject(agenteSupremo);
            escribir.close();
            
            //Leer
            ObjectInputStream leer = new ObjectInputStream(new FileInputStream(archivo.getAbsolutePath()+ "\\src\\BaseDatos\\temp.txt"));
            Agente agenteRecuperado = (Agente)leer.readObject();
            System.out.println(agenteRecuperado.getNombre());
            leer.close();
